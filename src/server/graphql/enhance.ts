...
const relationResolversInfo = {
  ...
  Staff: ['user', 'leaveRequests', 'staffFiles'],
  Post: ['author'],
  CalendarVacation: ['leaveRequest'],
  TimeSheet: ['calendar'],
  LeaveRequest: ['calendarVacation', 'staffFile', 'staff'],
  StaffFiles: ['staff', 'LeaveRequest'],
...
const inputsInfo = {
  ...
  StaffFilesCreateInput: ['filePath', 'fileType', 'staff', 'LeaveRequest'],
  StaffFilesUpdateInput: ['filePath', 'fileType', 'staff', 'LeaveRequest'],
