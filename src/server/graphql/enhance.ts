...
const crudResolversMap = {
  ...
  PublicHoliday: crudResolvers.PublicHolidayCrudResolver,
  CalendarVacation: crudResolvers.CalendarVacationCrudResolver,
...
const actionResolversMap = {
  ...
  PublicHoliday: {
    aggregatePublicHoliday: actionResolvers.AggregatePublicHolidayResolver,
    createOnePublicHoliday: actionResolvers.CreateOnePublicHolidayResolver,
    deleteManyPublicHoliday: actionResolvers.DeleteManyPublicHolidayResolver,
    deleteOnePublicHoliday: actionResolvers.DeleteOnePublicHolidayResolver,
    findFirstPublicHoliday: actionResolvers.FindFirstPublicHolidayResolver,
    findFirstPublicHolidayOrThrow:
      actionResolvers.FindFirstPublicHolidayOrThrowResolver,
    publicHolidays: actionResolvers.FindManyPublicHolidayResolver,
    publicHoliday: actionResolvers.FindUniquePublicHolidayResolver,
    getPublicHoliday: actionResolvers.FindUniquePublicHolidayOrThrowResolver,
    groupByPublicHoliday: actionResolvers.GroupByPublicHolidayResolver,
    updateManyPublicHoliday: actionResolvers.UpdateManyPublicHolidayResolver,
    updateOnePublicHoliday: actionResolvers.UpdateOnePublicHolidayResolver,
    upsertOnePublicHoliday: actionResolvers.UpsertOnePublicHolidayResolver,
  },
  CalendarVacation: {
    aggregateCalendarVacation:
      actionResolvers.AggregateCalendarVacationResolver,
    createOneCalendarVacation:
      actionResolvers.CreateOneCalendarVacationResolver,
    deleteManyCalendarVacation:
      actionResolvers.DeleteManyCalendarVacationResolver,
    deleteOneCalendarVacation:
      actionResolvers.DeleteOneCalendarVacationResolver,
    findFirstCalendarVacation:
      actionResolvers.FindFirstCalendarVacationResolver,
    findFirstCalendarVacationOrThrow:
      actionResolvers.FindFirstCalendarVacationOrThrowResolver,
    calendarVacations: actionResolvers.FindManyCalendarVacationResolver,
    calendarVacation: actionResolvers.FindUniqueCalendarVacationResolver,
    getCalendarVacation:
      actionResolvers.FindUniqueCalendarVacationOrThrowResolver,
    groupByCalendarVacation: actionResolvers.GroupByCalendarVacationResolver,
    updateManyCalendarVacation:
      actionResolvers.UpdateManyCalendarVacationResolver,
    updateOneCalendarVacation:
      actionResolvers.UpdateOneCalendarVacationResolver,
    upsertOneCalendarVacation:
      actionResolvers.UpsertOneCalendarVacationResolver,
  },
  TimeSheet: {
  ...
  StaffFiles: {
    aggregateStaffFiles: actionResolvers.AggregateStaffFilesResolver,
    createOneStaffFiles: actionResolvers.CreateOneStaffFilesResolver,
    deleteManyStaffFiles: actionResolvers.DeleteManyStaffFilesResolver,
    deleteOneStaffFiles: actionResolvers.DeleteOneStaffFilesResolver,
    findFirstStaffFiles: actionResolvers.FindFirstStaffFilesResolver,
    findFirstStaffFilesOrThrow:
      actionResolvers.FindFirstStaffFilesOrThrowResolver,
    findManyStaffFiles: actionResolvers.FindManyStaffFilesResolver,
    findUniqueStaffFiles: actionResolvers.FindUniqueStaffFilesResolver,
    findUniqueStaffFilesOrThrow:
      actionResolvers.FindUniqueStaffFilesOrThrowResolver,
    groupByStaffFiles: actionResolvers.GroupByStaffFilesResolver,
    updateManyStaffFiles: actionResolvers.UpdateManyStaffFilesResolver,
    updateOneStaffFiles: actionResolvers.UpdateOneStaffFilesResolver,
    upsertOneStaffFiles: actionResolvers.UpsertOneStaffFilesResolver,
  },
  TimeSheetCalendar: {
...
const crudResolversInfo = {
  ...
  PublicHoliday: [
    'aggregatePublicHoliday',
    'createOnePublicHoliday',
    'deleteManyPublicHoliday',
    'deleteOnePublicHoliday',
    'findFirstPublicHoliday',
    'findFirstPublicHolidayOrThrow',
    'publicHolidays',
    'publicHoliday',
    'getPublicHoliday',
    'groupByPublicHoliday',
    'updateManyPublicHoliday',
    'updateOnePublicHoliday',
    'upsertOnePublicHoliday',
  ],
  CalendarVacation: [
    'aggregateCalendarVacation',
    'createOneCalendarVacation',
  ...
  StaffFiles: [
    'aggregateStaffFiles',
    'createOneStaffFiles',
    'deleteManyStaffFiles',
    'deleteOneStaffFiles',
    'findFirstStaffFiles',
    'findFirstStaffFilesOrThrow',
    'findManyStaffFiles',
    'findUniqueStaffFiles',
    'findUniqueStaffFilesOrThrow',
    'groupByStaffFiles',
    'updateManyStaffFiles',
    'updateOneStaffFiles',
    'upsertOneStaffFiles',
  ],
  TimeSheetCalendar: [
...
const argsInfo = {
  ...
  AggregatePublicHolidayArgs: ['where', 'orderBy', 'cursor', 'take', 'skip'],
  CreateOnePublicHolidayArgs: ['data'],
  DeleteManyPublicHolidayArgs: ['where'],
  DeleteOnePublicHolidayArgs: ['where'],
  FindFirstPublicHolidayArgs: [
    'where',
    'orderBy',
    'cursor',
    'take',
  ...
  FindFirstPublicHolidayOrThrowArgs: [
    'where',
    'orderBy',
    'cursor',
    'take',
  ...
  FindUniquePublicHolidayArgs: ['where'],
  FindUniquePublicHolidayOrThrowArgs: ['where'],
  GroupByPublicHolidayArgs: [
    'where',
    'orderBy',
    'by',
    'having',
  ...
  UpdateManyPublicHolidayArgs: ['data', 'where'],
  UpdateOnePublicHolidayArgs: ['data', 'where'],
  UpsertOnePublicHolidayArgs: ['where', 'create', 'update'],
  AggregateCalendarVacationArgs: ['where', 'orderBy', 'cursor', 'take', 'skip'],
  CreateOneCalendarVacationArgs: ['data'],
  DeleteManyCalendarVacationArgs: ['where'],
  DeleteOneCalendarVacationArgs: ['where'],
  FindFirstCalendarVacationArgs: [
    'where',
    'orderBy',
    'cursor',
    'take',
  ...
  FindFirstCalendarVacationOrThrowArgs: [
    'where',
    'orderBy',
    'cursor',
    'take',
  ...
  FindUniqueCalendarVacationArgs: ['where'],
  FindUniqueCalendarVacationOrThrowArgs: ['where'],
  GroupByCalendarVacationArgs: [
    'where',
    'orderBy',
    'by',
    'having',
  ...
  UpdateManyCalendarVacationArgs: ['data', 'where'],
  UpdateOneCalendarVacationArgs: ['data', 'where'],
  UpsertOneCalendarVacationArgs: ['where', 'create', 'update'],
  ...
  AggregateStaffFilesArgs: ['where', 'orderBy', 'cursor', 'take', 'skip'],
  CreateOneStaffFilesArgs: ['data'],
  DeleteManyStaffFilesArgs: ['where'],
  DeleteOneStaffFilesArgs: ['where'],
  FindFirstStaffFilesArgs: [
    'where',
    'orderBy',
    'cursor',
    'take',
  ...
  FindFirstStaffFilesOrThrowArgs: [
    'where',
    'orderBy',
    'cursor',
    'take',
  ...
  FindUniqueStaffFilesArgs: ['where'],
  FindUniqueStaffFilesOrThrowArgs: ['where'],
  GroupByStaffFilesArgs: ['where', 'orderBy', 'by', 'having', 'take', 'skip'],
  UpdateManyStaffFilesArgs: ['data', 'where'],
  UpdateOneStaffFilesArgs: ['data', 'where'],
  UpsertOneStaffFilesArgs: ['where', 'create', 'update'],
...
const relationResolversMap = {
  ...
  CalendarVacation: relationResolvers.CalendarVacationRelationsResolver,
  TimeSheet: relationResolvers.TimeSheetRelationsResolver,
  LeaveRequest: relationResolvers.LeaveRequestRelationsResolver,
  StaffFiles: relationResolvers.StaffFilesRelationsResolver,
...
const relationResolversInfo = {
  ...
  Account: ['user'],
  Session: ['user'],
  Staff: ['leaveRequests', 'user', 'staffFiles'],
  User: ['accounts', 'sessions', 'staff'],
  Post: ['author'],
  CalendarVacation: ['leaveRequest'],
  TimeSheet: ['calendar'],
  LeaveRequest: ['calendarVacation', 'staff', 'staffFile'],
  StaffFiles: ['LeaveRequest', 'staff'],
...
const modelsInfo = {
  ...
  PublicHoliday: ['StartDate', 'EndDate', 'Summary'],
  CalendarVacation: ['VacationDate', 'ChargeableDay', 'LeaveRequestId'],
  TimeSheet: [
    'id',
    'StartDate',
    'EndDate',
  ...
  StaffFiles: ['id', 'filePath', 'fileType', 'staffId'],
  TimeSheetCalendar: [
    'id',
    'DayID',
    'CalendarDate',
...
const outputsInfo = {
  ...
  AggregatePublicHoliday: ['_count', '_min', '_max'],
  PublicHolidayGroupBy: [
    'StartDate',
    'EndDate',
    'Summary',
    '_count',
  ...
  AggregateCalendarVacation: ['_count', '_avg', '_sum', '_min', '_max'],
  CalendarVacationGroupBy: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
    '_count',
  ...
  AggregateStaffFiles: ['_count', '_avg', '_sum', '_min', '_max'],
  StaffFilesGroupBy: [
    'id',
    'filePath',
    'fileType',
  ...
  StaffCount: ['leaveRequests', 'staffFiles'],
  StaffCountAggregate: [
    'id',
    'StaffName',
    'AgentName',
  ...
  UserCount: ['accounts', 'sessions', 'staff'],
  UserCountAggregate: [
    'id',
    'username',
    'name',
  ...
  UserAvgAggregate: ['staffId'],
  UserSumAggregate: ['staffId'],
  UserMinAggregate: [
    'id',
    'username',
    'name',
  ...
  PublicHolidayCountAggregate: ['StartDate', 'EndDate', 'Summary', '_all'],
  PublicHolidayMinAggregate: ['StartDate', 'EndDate', 'Summary'],
  PublicHolidayMaxAggregate: ['StartDate', 'EndDate', 'Summary'],
  CalendarVacationCountAggregate: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
    '_all',
  ],
  CalendarVacationAvgAggregate: ['ChargeableDay', 'LeaveRequestId'],
  CalendarVacationSumAggregate: ['ChargeableDay', 'LeaveRequestId'],
  CalendarVacationMinAggregate: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
  ],
  CalendarVacationMaxAggregate: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
  ],
  ...
  LeaveRequestCount: ['calendarVacation'],
  ...
  LeaveRequestAvgAggregate: ['id', 'leaveDays', 'fileId', 'staffId'],
  LeaveRequestSumAggregate: ['id', 'leaveDays', 'fileId', 'staffId'],
  ...
  StaffFilesCount: ['LeaveRequest'],
  StaffFilesCountAggregate: ['id', 'filePath', 'fileType', 'staffId', '_all'],
  StaffFilesAvgAggregate: ['id', 'staffId'],
  StaffFilesSumAggregate: ['id', 'staffId'],
  StaffFilesMinAggregate: ['id', 'filePath', 'fileType', 'staffId'],
  StaffFilesMaxAggregate: ['id', 'filePath', 'fileType', 'staffId'],
...
const inputsInfo = {
  ...
  PublicHolidayOrderByWithRelationInput: ['StartDate', 'EndDate', 'Summary'],
  PublicHolidayWhereUniqueInput: ['StartDate'],
  PublicHolidayOrderByWithAggregationInput: [
    'StartDate',
    'EndDate',
    'Summary',
    '_count',
  ...
  PublicHolidayScalarWhereWithAggregatesInput: [
    'AND',
    'OR',
    'NOT',
    'StartDate',
  ...
  CalendarVacationOrderByWithRelationInput: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
    'leaveRequest',
  ],
  CalendarVacationWhereUniqueInput: ['VacationDate'],
  CalendarVacationOrderByWithAggregationInput: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
    '_count',
  ...
  CalendarVacationScalarWhereWithAggregatesInput: [
    'AND',
    'OR',
    'NOT',
    'VacationDate',
  ...
  StaffFilesOrderByWithRelationInput: [
    'id',
    'filePath',
    'fileType',
    'staffId',
  ...
  StaffFilesWhereUniqueInput: ['id'],
  StaffFilesOrderByWithAggregationInput: [
    'id',
    'filePath',
    'fileType',
    'staffId',
  ...
  StaffFilesScalarWhereWithAggregatesInput: [
    'AND',
    'OR',
    'NOT',
    'id',
  ...
  PublicHolidayCreateInput: ['StartDate', 'EndDate', 'Summary'],
  PublicHolidayUpdateInput: ['StartDate', 'EndDate', 'Summary'],
  PublicHolidayUpdateManyMutationInput: ['StartDate', 'EndDate', 'Summary'],
  CalendarVacationCreateInput: [
    'VacationDate',
    'ChargeableDay',
    'leaveRequest',
  ],
  CalendarVacationUpdateInput: [
    'VacationDate',
    'ChargeableDay',
    'leaveRequest',
  ],
  CalendarVacationUpdateManyMutationInput: ['VacationDate', 'ChargeableDay'],
  ...
  StaffFilesCreateInput: ['filePath', 'fileType', 'LeaveRequest', 'staff'],
  StaffFilesUpdateInput: ['filePath', 'fileType', 'LeaveRequest', 'staff'],
  StaffFilesUpdateManyMutationInput: ['filePath', 'fileType'],
  ...
  StaffFilesListRelationFilter: ['every', 'some', 'none'],
  LeaveRequestOrderByRelationAggregateInput: ['_count'],
  StaffFilesOrderByRelationAggregateInput: ['_count'],
  ...
  UserAvgOrderByAggregateInput: ['staffId'],
  ...
  UserSumOrderByAggregateInput: ['staffId'],
  ...
  PublicHolidayCountOrderByAggregateInput: ['StartDate', 'EndDate', 'Summary'],
  PublicHolidayMaxOrderByAggregateInput: ['StartDate', 'EndDate', 'Summary'],
  PublicHolidayMinOrderByAggregateInput: ['StartDate', 'EndDate', 'Summary'],
  DecimalFilter: ['equals', 'in', 'notIn', 'lt', 'lte', 'gt', 'gte', 'not'],
  LeaveRequestRelationFilter: ['is', 'isNot'],
  CalendarVacationCountOrderByAggregateInput: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
  ],
  CalendarVacationAvgOrderByAggregateInput: ['ChargeableDay', 'LeaveRequestId'],
  CalendarVacationMaxOrderByAggregateInput: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
  ],
  CalendarVacationMinOrderByAggregateInput: [
    'VacationDate',
    'ChargeableDay',
    'LeaveRequestId',
  ],
  CalendarVacationSumOrderByAggregateInput: ['ChargeableDay', 'LeaveRequestId'],
  ...
  CalendarVacationListRelationFilter: ['every', 'some', 'none'],
  StaffRelationFilter: ['is', 'isNot'],
  StaffFilesRelationFilter: ['is', 'isNot'],
  CalendarVacationOrderByRelationAggregateInput: ['_count'],
  ...
  LeaveRequestAvgOrderByAggregateInput: [
    'id',
    'leaveDays',
    'fileId',
    'staffId',
  ...
  LeaveRequestSumOrderByAggregateInput: [
    'id',
    'leaveDays',
    'fileId',
    'staffId',
  ...
  StaffFilesCountOrderByAggregateInput: [
    'id',
    'filePath',
    'fileType',
    'staffId',
  ],
  StaffFilesAvgOrderByAggregateInput: ['id', 'staffId'],
  StaffFilesMaxOrderByAggregateInput: ['id', 'filePath', 'fileType', 'staffId'],
  StaffFilesMinOrderByAggregateInput: ['id', 'filePath', 'fileType', 'staffId'],
  StaffFilesSumOrderByAggregateInput: ['id', 'staffId'],
  ...
  StaffFilesCreateNestedManyWithoutStaffInput: [
    'create',
    'connectOrCreate',
    'connect',
  ],
  ...
  StaffFilesUpdateManyWithoutStaffNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'set',
  ...
  StaffCreateNestedManyWithoutUserInput: [
    'create',
    'connectOrCreate',
    'connect',
  ],
  ...
  StaffUpdateManyWithoutUserNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'set',
  ...
  LeaveRequestCreateNestedOneWithoutCalendarVacationInput: [
    'create',
    'connectOrCreate',
    'connect',
  ],
  ...
  LeaveRequestUpdateOneRequiredWithoutCalendarVacationNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'connect',
  ...
  StaffFilesCreateNestedOneWithoutLeaveRequestInput: [
    'create',
    'connectOrCreate',
    'connect',
  ],
  ...
  LeaveRequestCreateNestedManyWithoutStaffFileInput: [
    'create',
    'connectOrCreate',
    'connect',
  ],
  StaffCreateNestedOneWithoutStaffFilesInput: [
    'create',
    'connectOrCreate',
    'connect',
  ],
  LeaveRequestUpdateManyWithoutStaffFileNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'set',
  ...
  StaffUpdateOneRequiredWithoutStaffFilesNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'connect',
  ...
  StaffFilesCreateWithoutStaffInput: ['filePath', 'fileType', 'LeaveRequest'],
  StaffFilesCreateOrConnectWithoutStaffInput: ['where', 'create'],
  ...
  StaffFilesUpsertWithWhereUniqueWithoutStaffInput: [
    'where',
    'update',
    'create',
  ],
  StaffFilesUpdateWithWhereUniqueWithoutStaffInput: ['where', 'data'],
  StaffFilesUpdateManyWithWhereWithoutStaffInput: ['where', 'data'],
  StaffFilesScalarWhereInput: [
    'AND',
    'OR',
    'NOT',
    'id',
  ...
  StaffUpsertWithWhereUniqueWithoutUserInput: ['where', 'update', 'create'],
  StaffUpdateWithWhereUniqueWithoutUserInput: ['where', 'data'],
  StaffUpdateManyWithWhereWithoutUserInput: ['where', 'data'],
  StaffScalarWhereInput: [
    'AND',
    'OR',
    'NOT',
    'id',
  ...
  LeaveRequestCreateWithoutCalendarVacationInput: [
    'leavePeriodStart',
    'AMPMStart',
    'leavePeriodEnd',
    'AMPMEnd',
  ...
  LeaveRequestCreateOrConnectWithoutCalendarVacationInput: ['where', 'create'],
  LeaveRequestUpsertWithoutCalendarVacationInput: ['update', 'create'],
  LeaveRequestUpdateWithoutCalendarVacationInput: [
    'leavePeriodStart',
    'AMPMStart',
    'leavePeriodEnd',
    'AMPMEnd',
  ...
  CalendarVacationCreateWithoutLeaveRequestInput: [
    'VacationDate',
    'ChargeableDay',
  ],
  CalendarVacationCreateOrConnectWithoutLeaveRequestInput: ['where', 'create'],
  ...
  StaffFilesCreateWithoutLeaveRequestInput: ['filePath', 'fileType', 'staff'],
  StaffFilesCreateOrConnectWithoutLeaveRequestInput: ['where', 'create'],
  CalendarVacationUpsertWithWhereUniqueWithoutLeaveRequestInput: [
    'where',
    'update',
    'create',
  ],
  CalendarVacationUpdateWithWhereUniqueWithoutLeaveRequestInput: [
    'where',
    'data',
  ],
  CalendarVacationUpdateManyWithWhereWithoutLeaveRequestInput: [
    'where',
    'data',
  ],
  CalendarVacationScalarWhereInput: [
    'AND',
    'OR',
    'NOT',
    'VacationDate',
  ...
  StaffFilesUpsertWithoutLeaveRequestInput: ['update', 'create'],
  StaffFilesUpdateWithoutLeaveRequestInput: ['filePath', 'fileType', 'staff'],
  LeaveRequestCreateWithoutStaffFileInput: [
    'leavePeriodStart',
    'AMPMStart',
    'leavePeriodEnd',
    'AMPMEnd',
  ...
  LeaveRequestCreateOrConnectWithoutStaffFileInput: ['where', 'create'],
  StaffCreateWithoutStaffFilesInput: [
    'StaffName',
    'AgentName',
    'StaffCategory',
    'Department',
  ...
  StaffCreateOrConnectWithoutStaffFilesInput: ['where', 'create'],
  LeaveRequestUpsertWithWhereUniqueWithoutStaffFileInput: [
    'where',
    'update',
    'create',
  ],
  LeaveRequestUpdateWithWhereUniqueWithoutStaffFileInput: ['where', 'data'],
  LeaveRequestUpdateManyWithWhereWithoutStaffFileInput: ['where', 'data'],
  StaffUpsertWithoutStaffFilesInput: ['update', 'create'],
  StaffUpdateWithoutStaffFilesInput: [
    'StaffName',
    'AgentName',
    'StaffCategory',
    'Department',
  ...
  StaffFilesUpdateWithoutStaffInput: ['filePath', 'fileType', 'LeaveRequest'],
  ...
  CalendarVacationUpdateWithoutLeaveRequestInput: [
    'VacationDate',
    'ChargeableDay',
  ],
  LeaveRequestUpdateWithoutStaffFileInput: [
    'leavePeriodStart',
    'AMPMStart',
    'leavePeriodEnd',
    'AMPMEnd',
